...
// node_modules/react-carousel3/dist/esm/Carousel/index.js
...
function renderItem(item, _ref) {
  var rotation = _ref.rotation, farScale = _ref.farScale, xOrigin = _ref.xOrigin, yOrigin = _ref.yOrigin, xRadius = _ref.xRadius, yRadius = _ref.yRadius;
...
function render(items, _ref2) {
  var rotation = _ref2.rotation, farScale = _ref2.farScale, xOrigin = _ref2.xOrigin, yOrigin = _ref2.yOrigin, xRadius = _ref2.xRadius, yRadius = _ref2.yRadius;
...
function floatIndex(itemCount, rotation) {
  var count = itemCount;
  var floatIndex2 = itemsRotated(itemCount, rotation) % count;
  return floatIndex2 < 0 ? floatIndex2 + count : floatIndex2;
}
...
function play(destRotation, rotation, speed, fn) {
  ...
  function playFrame() {
    ...
    var now = time();
    var dt = (now - lastTime) * 2e-3;
    lastTime = now;
    if (Math.abs(rem) < 3e-3) {
...
function content(items, onClick) {
  ...
  return items.map(function(item, index) {
    return (0, import_react.cloneElement)(item, {
      index,
      onClick,
...
function Carousel(props) {
  var children = props.children, height = props.height, width = props.width, autoPlay = props.autoPlay;
  var boxRef = (0, import_react.useRef)(null);
  var playTimer = (0, import_react.useRef)(0);
  var rotation = (0, import_react.useRef)(Math.PI / 2);
  var destRotation = (0, import_react.useRef)(Math.PI / 2);
  var farScale = 0.5;
  var speed = 4;
  var carousel = (0, import_react.useCallback)(function(index) {
    ...
    play(destRotation.current, rotation.current, speed, function(data, timer) {
      ...
      var _xy = xy(boxRef.current, props), xOrigin = _xy.xOrigin, yOrigin = _xy.yOrigin, xRadius = _xy.xRadius, yRadius = _xy.yRadius;
  ...
  (0, import_react.useEffect)(function() {
    ...
    var autoPlayTimer;
    var children2 = ((_boxRef$current2 = boxRef.current) === null || _boxRef$current2 === void 0 ? void 0 : _boxRef$current2.children) || [];
    var _xy2 = xy(boxRef.current, props), xOrigin = _xy2.xOrigin, yOrigin = _xy2.yOrigin, xRadius = _xy2.xRadius, yRadius = _xy2.yRadius;
    render(children2, {
  ...
  var itemClick = (0, import_react.useCallback)(function(e) {
...
//# sourceMappingURL=react-carousel3.js.map
